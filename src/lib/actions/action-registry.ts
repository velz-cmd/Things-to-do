...
const rows: readonly CatalogRow[] = [
  ...
  { id: "discover.open_external_record", label: "Open external market record", owner: "discover", execution: { kind: "navigation", destination: "[sourceUrl]" }, risk: "read", queries: ["discover-oss-intelligence"] },
  { id: "discover.open_evidence", label: "Open verified GitHub evidence", owner: "discover", execution: { kind: "navigation", destination: "/api/discover/oss-evidence/[evidenceId]" }, risk: "read", queries: ["discover-oss-intelligence"] },
  { id: "discover.review_funding", label: "Review funding", owner: "discover", execution: { kind: "navigation", destination: "/discover?view=explore&item=[itemId]" }, risk: "read", queries: ["discover"] },
  { id: "discover.start_mission", label: "Open funding decision in Mission", owner: "discover", execution: { kind: "mutation", endpoint: "/api/discover/oss-missions", method: "POST" }, auth: true, risk: "write", recovery: "discover.capture_repository_snapshot", queries: ["discover-oss-intelligence", "mission"] },
  { id: "discover.open_program", label: "Open matching program", owner: "discover", execution: { kind: "navigation", destination: "/programs/[programId]" }, risk: "read", queries: ["discover-oss-intelligence", "community-surface"] },
  { id: "discover.resolve_identity", label: "Resolve contributor identity", owner: "discover", execution: { kind: "navigation", destination: "/profile?section=identity&returnTo=[returnTo]" }, auth: true, risk: "write", recovery: "profile.manage_connections", queries: ["discover-oss-intelligence", "profile-state"] },
  { id: "discover.search_ledger", label: "Search Work Ledger", owner: "discover", execution: { kind: "client", handler: "discover-ledger-search" }, risk: "read", queries: ["discover-oss-intelligence"] },
  { id: "discover.filter_ledger", label: "Filter Work Ledger", owner: "discover", execution: { kind: "client", handler: "discover-ledger-filter" }, risk: "read", queries: ["discover-oss-intelligence"] },
  { id: "discover.compare_periods", label: "Compare evaluation periods", owner: "discover", execution: { kind: "client", handler: "discover-period-comparison" }, risk: "read", queries: ["discover-oss-intelligence"] },
  { id: "discover.open_record", label: "Open Work Ledger record", owner: "discover", execution: { kind: "client", handler: "discover-record-drawer" }, risk: "read", queries: ["discover-oss-intelligence"] },
  { id: "discover.open_pools", label: "Open repository Pools", owner: "discover", execution: { kind: "client", handler: "discover-secondary-panel" }, risk: "read", queries: ["discover-oss-intelligence"] },
  { id: "discover.open_contributors", label: "Open repository contributors", owner: "discover", execution: { kind: "client", handler: "discover-secondary-panel" }, risk: "read", queries: ["discover-oss-intelligence"] },
  { id: "discover.open_activity", label: "Open repository activity", owner: "discover", execution: { kind: "client", handler: "discover-secondary-panel" }, risk: "read", queries: ["discover-oss-intelligence"] },
  { id: "discover.open_outcomes", label: "Open confirmed outcomes", owner: "discover", execution: { kind: "client", handler: "discover-secondary-panel" }, risk: "read", queries: ["discover-oss-intelligence", "receipts"] },
  { id: "discover.open_advanced", label: "Open advanced source details", owner: "discover", execution: { kind: "client", handler: "discover-secondary-panel" }, risk: "read", queries: ["discover-oss-intelligence"] },
  { id: "discover.open_people", label: "Explore verified people", owner: "discover", execution: { kind: "navigation", destination: "/discover?view=explore&kind=people" }, risk: "read", queries: ["discover"] },
  { id: "discover.open_funding_pools", label: "Explore community Pools", owner: "discover", execution: { kind: "navigation", destination: "/discover?view=explore&kind=pools" }, risk: "read", queries: ["discover", "communities"] },
  { id: "discover.open_verified_work", label: "Explore verified work", owner: "discover", execution: { kind: "navigation", destination: "/discover?view=explore&kind=work" }, risk: "read", queries: ["discover"] },
  { id: "discover.fund_verified_work", label: "Fund verified work", owner: "discover", execution: { kind: "mutation", endpoint: "/api/wallet/send", method: "POST" }, auth: true, risk: "money", recovery: "profile.set_payout_destination", queries: ["discover", "capital-state", "receipts"] },
  { id: "discover.post_request", label: "Post request", owner: "discover", execution: { kind: "mutation", endpoint: "/api/discover/requests", method: "POST" }, auth: true, risk: "money", recovery: "capital.select_wallet", queries: ["discover", "capital-state"] },
  { id: "discover.view_request", label: "View request", owner: "discover", execution: { kind: "client", handler: "discover-request-workbench" }, risk: "read", queries: ["discover"] },
  { id: "discover.take_request", label: "Take request", owner: "discover", execution: { kind: "mutation", endpoint: "/api/discover/requests", method: "POST" }, auth: true, risk: "write", queries: ["discover"] },
  { id: "discover.submit_request_work", label: "Submit work", owner: "discover", execution: { kind: "mutation", endpoint: "/api/discover/requests", method: "POST" }, auth: true, risk: "write", recovery: "discover.open_evidence", queries: ["discover"] },
  { id: "discover.review_request", label: "Review work", owner: "discover", execution: { kind: "mutation", endpoint: "/api/discover/requests", method: "POST" }, auth: true, risk: "write", queries: ["discover"] },
  { id: "discover.release_request", label: "Release payment", owner: "discover", execution: { kind: "mutation", endpoint: "/api/discover/requests", method: "POST" }, auth: true, risk: "money", recovery: "discover.review_request", queries: ["discover", "receipts"] },
  { id: "discover.refund_request", label: "Cancel and refund", owner: "discover", execution: { kind: "mutation", endpoint: "/api/discover/requests", method: "POST" }, auth: true, risk: "money", queries: ["discover", "receipts"] },
  { id: "discover.track_request", label: "Track request", owner: "discover", execution: { kind: "client", handler: "discover-request-workbench" }, auth: true, risk: "read", queries: ["discover", "receipts"] },
  { id: "discover.create_support_bundle", label: "Create support bundle", owner: "discover", execution: { kind: "mutation", endpoint: "/api/wallet/send", method: "POST" }, auth: true, risk: "money", recovery: "profile.set_payout_destination", queries: ["discover", "capital-state", "receipts"] },
  { id: "discover.inspect_agent_service", label: "Inspect agent service", owner: "discover", execution: { kind: "client", handler: "discover-agent-service-workbench" }, risk: "read", queries: ["discover", "agent-services"] },
  { id: "discover.quote_agent_service", label: "Get current agent-service quote", owner: "discover", execution: { kind: "client", handler: "discover-agent-service-quote" }, risk: "read", queries: ["discover", "agent-services"] },
  { id: "discover.run_agent_service", label: "Run agent service", owner: "discover", execution: { kind: "mutation", endpoint: "/api/agent/invoke", method: "POST" }, auth: true, risk: "money", recovery: "capital.select_wallet", queries: ["discover", "agent-services", "capital-state", "receipts"] },
  { id: "discover.open_communities", label: "Open Communities", owner: "discover", execution: { kind: "navigation", destination: "/communities" }, risk: "read", queries: ["communities"] },
  ...
  { id: "receipt.open", label: "Open outcome receipt", owner: "capital", execution: { kind: "navigation", destination: "/outcomes/[publicReference]" }, risk: "read", queries: ["receipts"] },
  ...
  { id: "profile.install_github_app", label: "Install GitHub repository access", owner: "profile", execution: { kind: "navigation", destination: "/connect/github/install?returnTo=[returnTo]" }, auth: true, risk: "write", recovery: "profile.connect_source", queries: ["profile-bootstrap", "profile-state", "discover"] },
