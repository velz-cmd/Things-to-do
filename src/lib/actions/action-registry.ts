...
const rows: readonly CatalogRow[] = [
  ...
  { id: "discover.open_people", label: "Fund a verified person", owner: "discover", execution: { kind: "navigation", destination: "/discover?view=people" }, risk: "read", queries: ["discover"] },
  { id: "discover.open_funding_pools", label: "Back a community Pool", owner: "discover", execution: { kind: "navigation", destination: "/discover?view=pools" }, risk: "read", queries: ["discover", "communities"] },
  { id: "discover.open_verified_work", label: "Fund verified work", owner: "discover", execution: { kind: "navigation", destination: "/discover?view=work" }, risk: "read", queries: ["discover"] },
