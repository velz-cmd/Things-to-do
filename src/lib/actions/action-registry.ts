...
const rows: readonly CatalogRow[] = [
  ...
  { id: "capital.review_authorization", label: "Review authorization package", owner: "capital", execution: { kind: "navigation", destination: "/capital?view=authorizations&authorization=[authorizationId]" }, auth: true, risk: "read", queries: ["capital-bootstrap"] },
  { id: "capital.run_preflight", label: "Run settlement preflight", owner: "capital", execution: { kind: "navigation", destination: "/capital?view=authorizations&authorization=[authorizationId]&mode=preflight" }, auth: true, risk: "read", queries: ["capital-bootstrap"] },
  ...
  { id: "profile.set_payout_destination", label: "Set payout destination", owner: "profile", execution: { kind: "mutation", endpoint: "/api/outcomes/identity", method: "POST" }, auth: true, risk: "money", recovery: "profile.verify_payout_destination", queries: ["profile-bootstrap", "capital-bootstrap"] },
