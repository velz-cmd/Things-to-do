  ...
  return (
    <header className={clsx("discover-on-canvas relative mb-7", className)}>
      <DiscoverCapitalCard className="discover-operating-hero" padding={false} hover={false}>
        <div className="relative overflow-visible px-4 py-4 sm:px-7 sm:py-6 lg:px-8">
          <div aria-hidden className="discover-operating-hero__flare" />
          <div className="relative grid items-start gap-7 lg:grid-cols-[minmax(0,1.16fr)_minmax(430px,.94fr)] xl:gap-8">
            <div className="min-w-0">
              ...
              <p className="mt-3 max-w-3xl text-sm leading-6 text-resolve-muted sm:text-[15px]">
                {DISCOVER_HERO_SUBTITLE}
              </p>

              <div className="relative mt-5 grid gap-2.5 sm:grid-cols-2 xl:grid-cols-3" role="tablist" aria-label="Discover intent">
