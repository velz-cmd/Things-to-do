export const queryKeys = {
  ...
  capitalBootstrap: ["capital", "bootstrap"] as const,
  capitalBalanceWallet: (address: string) => ["capital", "balance", address.toLowerCase()] as const,
  capitalAuthorizations: ["capital", "authorizations"] as const,
  capitalSettlements: ["capital", "settlements"] as const,
  capitalActivity: ["capital", "activity"] as const,
  capitalGuardrails: ["capital", "guardrails"] as const,
  capitalReceipt: (id: string) => ["capital", "receipt", id] as const,
